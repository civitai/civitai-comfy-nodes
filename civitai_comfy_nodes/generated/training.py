...
class CivitaiTrainingAiToolkitFlux1(CivitaiRecipeNodeBase):
    ...
    FIELDS = {
        ...
        "requires_age_classification": F("requiresAgeClassification", "value"),
        "epochs": F("epochs", "value"),
        "steps": F("steps", "value"),
        ...
        return {
            "required": {
                ...
                "uses_step_pricing": (
                    "BOOLEAN",
                    {
                        "tooltip": "Whether this run uses step-based pricing rather than the legacy flat per-epoch price.",
                        "default": False,
                    },
                ),
                "requires_age_classification": (
                    "BOOLEAN",
                    {
                        "tooltip": "Whether age classification should run on this training type's dataset.",
                        "default": False,
                    },
                ),
...
class CivitaiTrainingAiToolkitAnima(CivitaiRecipeNodeBase):
    """anima — training recipe via Civitai Orchestration."""

    RECIPE = "training"
    STEP_TYPE = "training"
    DISCRIMINATOR = {"engine": "ai-toolkit", "ecosystem": "anima"}
    CATEGORY = "Civitai/Training/anima"
    FUNCTION = "run"
    RETURN_TYPES = ("STRING", "STRING", "STRING", "STRING")
    RETURN_NAMES = ("moderation_status", "epochs", "workflow_id", "raw_json")
    FIELDS = {
        ...
        return {
            ...
            "optional": {
                ...
                "model": (
                    "CIVITAI_AIR",
                    {
                        "tooltip": "The primary Anima model to train upon. Custom checkpoints use the base Anima repository as extras."
                    },
                ),
                "api_config": (
                    "CIVITAI_CONFIG",
...
class CivitaiTrainingComfy(CivitaiRecipeNodeBase):
    """comfy — training recipe via Civitai Orchestration."""

    RECIPE = "training"
    STEP_TYPE = "training"
    DISCRIMINATOR = {"engine": "comfy"}
    CATEGORY = "Civitai/Training/comfy"
    FUNCTION = "run"
    RETURN_TYPES = ("STRING", "STRING", "STRING", "STRING")
    RETURN_NAMES = ("moderation_status", "epochs", "workflow_id", "raw_json")
    FIELDS = {
        ...
        "default_steps": F("defaultSteps", "value"),
        "resolution": F("resolution", "value"),
        "no_half_vae": F("noHalfVae", "value"),
        "min_snr_gamma": F("minSnrGamma", "value"),
        "model": F("model", "air"),
        "diffusion_model": F("diffusionModel", "air"),
        "text_encoder_model": F("textEncoderModel", "air"),
        "vae_model": F("vaeModel", "air"),
        "training_dtype": F("trainingDtype", "value"),
        "lora_dtype": F("loraDtype", "value"),
        "quantized_backward": F("quantizedBackward", "value"),
        "bypass_mode": F("bypassMode", "value"),
        "grad_accumulation_steps": F("gradAccumulationSteps", "value"),
        "loss_function": F("lossFunction", "value"),
        "algorithm": F("algorithm", "value"),
        "checkpoint_depth": F("checkpointDepth", "value"),
        "offloading": F("offloading", "value"),
        "clip_type": F("clipType", "value"),
        "unet_weight_dtype": F("unetWeightDtype", "value"),
        "model_sampling_shift": F("modelSamplingShift", "value"),
        "dataset_caching": F("datasetCaching", "value"),
        "max_batch_size": F("maxBatchSize", "value"),
    }
    OUTPUTS = (
        O("moderationStatus", "json"),
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "max_batch_size": ("INT", {"default": 0, "min": 0, "max": 2147483647, "step": 1}),
            },
            "optional": {
                "samples_json": (
                    "STRING",
                ...
                "batch_size": (
                    "INT",
                    {
                        "tooltip": "Training batch size. Defaults to 1; raise it up to 4 for this ecosystem to train faster at the cost of more GPU memory.",
                        "default": 1,
                        "min": 1,
                        "max": 4,
                        "step": 1,
                ...
                "resolution": ("INT", {"default": 1024, "min": 256, "max": 1024, "step": 1}),
                "no_half_vae": ("BOOLEAN", {"default": False}),
                "min_snr_gamma": (
                    "INT",
                    {
                        "tooltip": "Min-SNR gamma passed through to compatible training backends.",
                        "default": 0,
                        "min": 0,
                        "max": 20,
                        "step": 1,
                ...
                "model": (
                    "CIVITAI_AIR",
                    {
                        "tooltip": "The primary checkpoint to train upon. The model ecosystem drives Comfy training behavior."
                    },
                ),
                "diffusion_model": (
                    "CIVITAI_AIR",
                    {
                        "tooltip": "Split diffusion model used by native Comfy training nodes. When omitted, checkpoint-backed families load Civitai.Orchestration.Grains.Workflows.Steps.Training.Comfy.ComfyTrainingInput.Model."
                    },
                ),
                "text_encoder_model": (
                    "CIVITAI_AIR",
                    {"tooltip": "Split text encoder used by native Comfy training nodes."},
                ),
                "vae_model": ("CIVITAI_AIR", {"tooltip": "Split VAE used by native Comfy training nodes."}),
                "training_dtype": ("STRING", {"default": ""}),
                "lora_dtype": ("STRING", {"default": ""}),
                "quantized_backward": ("BOOLEAN", {"default": False}),
                "bypass_mode": ("BOOLEAN", {"default": False}),
                "grad_accumulation_steps": ("INT", {"default": 0, "min": 0, "max": 2147483647, "step": 1}),
                "loss_function": ("STRING", {"default": ""}),
                "algorithm": ("STRING", {"default": ""}),
                "checkpoint_depth": ("INT", {"default": 0, "min": 0, "max": 2147483647, "step": 1}),
                "offloading": ("BOOLEAN", {"default": False}),
                "clip_type": ("STRING", {"default": ""}),
                "unet_weight_dtype": ("STRING", {"default": ""}),
                "model_sampling_shift": ("FLOAT", {"default": 0.0, "min": 0.0, "max": 2147483647.0, "step": 0.01}),
                "dataset_caching": ("BOOLEAN", {"default": False}),
                "api_config": (
                    "CIVITAI_CONFIG",
                    {
                        "tooltip": "Optional Civitai Auth connection; defaults to CIVITAI_API_TOKEN or stored OAuth login."
...
NODE_CLASS_MAPPINGS = {
    ...
    "CivitaiTrainingAiToolkitAnima": CivitaiTrainingAiToolkitAnima,
    "CivitaiTrainingComfy": CivitaiTrainingComfy,
}
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "CivitaiTrainingAiToolkitAnima": "anima",
    "CivitaiTrainingComfy": "comfy",
}
